...
INSERT INTO `atendimento` (`id`, `data`, `hora`, `status`, `convenio_id`, `paciente_id`, `profissional_id`) VALUES
    (1,'2025-10-21','14:00:00','AGENDADO',1,1,1),
    (2,'2025-10-21','14:00:00','AGENDADO',1,2,3),
    (3,'2025-10-21','14:30:00','AGENDADO',2,3,4),
    (4,'2025-10-21','15:00:00','AGENDADO',3,4,1),
    (5,'2025-10-21','15:00:00','AGENDADO',1,5,5);
...
INSERT INTO `usuario` (`id`, `ativo`, `nome_completo`, `nome_usuario`, `papel`, `senha`) VALUES
    ...
    (3,b'1','Teste','teste','ATENDENTE','teste');
